...
- Order Service -> Payment Service (оплата)
...
**Что это:** Все домены в одном приложении, одна база данных на всё. Код лежит в одной папке, всё деплоится одной войной/джарником.
